<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminUpdateCon.aspx.cs" MasterPageFile="~/BackToDash.Master" Inherits="Industrial_Experts.AdminUpdateCon" %>
...
<asp:TextBox ID="txtsearch" runat="server" CssClass="form-control text-center  wider-textbox" PlaceHolder="Search ITI Regestration Number"></asp:TextBox>
    ...
    <asp:GridView runat="server" ID="UpdateCon" Height="150px" AutoGenerateColumns="False" 
        CssClass="table table-condensed table-hover text-center mt-3" OnRowCommand="UpdateCon_RowCommand" OnRowDeleting="UpdateCon_RowDeleting" DataKeyNames="ItiRegNo">
        <Columns>
